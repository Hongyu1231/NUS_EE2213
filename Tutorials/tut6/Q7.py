...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.4, random_state = 42) #Divide the set into 0.6 and 0.4 first
X_val, X_test, y_val, y_test = train_test_split(X_test, y_test, test_size = 0.5, random_state = 42) #Cut the 0.4 portion by half
...
print(df.corr()['target'].drop('target'))
